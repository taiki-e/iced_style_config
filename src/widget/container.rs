...
impl StyleSheet {
    ...
    where
        Renderer::Theme: iced_style::container::StyleSheet,
    {
...
pub(crate) struct Style(iced_style::container::Appearance);

impl iced_style::container::StyleSheet for Style {
    fn appearance(&self) -> iced_style::container::Appearance {
        self.0
    }
}
...
mod de {
    ...
    impl<'de> Deserialize<'de> for super::Style {
            ...
            D: Deserializer<'de>,
        {
            ...
            let mut this = iced_style::container::Appearance::default();
